...
#
execute as @e[type=villager,sort=nearest,limit=1,distance=..3,tag=susceptible] at @s run scoreboard players operation @s bell_igm = @s bell
execute as @e[type=villager,sort=nearest,limit=1,distance=..3,tag=exposed_glas] at @s run scoreboard players operation @s bell_igm = @s bell
