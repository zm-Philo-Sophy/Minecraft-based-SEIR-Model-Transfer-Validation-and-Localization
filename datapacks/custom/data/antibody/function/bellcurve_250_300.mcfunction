...
execute store result score @s random run random value 250..300
execute store result score @s random2 run random value 250..300
execute store result score @s bell run random value 250..300
#
