...
# Salmonella check
execute if entity @s[tag=has_salmonella] unless entity @s[tag=data_given] run loot insert -2062 65 -34997 loot sequences:villager/salmonella

# Commensals check  
execute if entity @s[tag=has_commensals] unless entity @s[tag=data_given] run loot insert -2062 65 -34997 loot sequences:villager/commensals

# RV check
execute if entity @s[tag=has_rv] unless entity @s[tag=data_given] run loot insert -2062 65 -34997 loot sequences:villager/rv

# Influenza check
execute if entity @s[tag=has_influenza] unless entity @s[tag=data_given] run loot insert -2062 65 -34997 loot sequences:villager/influenza

# Vibrio check
execute if entity @s[tag=has_vibrio] unless entity @s[tag=data_given] run loot insert -2062 65 -34997 loot sequences:villager/vibrio
