...
execute store result score @s hb_main run random value 5..6
#
#decimal calculator
...
######## STEP-1: three independent draws from the range
execute store result score @s random run random value 15..20
execute store result score @s random2 run random value 15..20
execute store result score @s bell run random value 15..20
#
######## STEP-2: Add all together
scoreboard players operation @s bell += @s random
scoreboard players operation @s bell += @s random2
